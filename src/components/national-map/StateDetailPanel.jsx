          ...
          {!hasData ? (
            ...
            <>
              ...
              <div className="px-5 py-4 border-b border-gray-100">
                <p className="text-xs text-gray-400 mb-1">Quick overview of alliance pipeline coverage in this state</p>
              ...
              {data.top_companies?.length > 0 && (
                <div className="px-5 py-4 border-b border-gray-100">
                  <p className="text-xs text-gray-400 mb-1">Top prospects by signal strength — click through to the Prospects tab for the full list</p>
              ...
              {/* Prompt Builder */}
              <div className="px-5 py-4 border-b border-gray-100">
                <p className="text-xs text-gray-400 mb-1">Generate a ready-to-run research prompt customized for this state</p>
                <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">Prompt Builder</h3>
                <button
                  onClick={() => setShowPromptBuilder(true)}
                  className="flex items-center gap-2 px-4 py-2.5 text-sm font-medium text-[#041E42] bg-white border border-[#041E42]/30 rounded-lg hover:bg-[#041E42]/5 transition-colors"
                >
