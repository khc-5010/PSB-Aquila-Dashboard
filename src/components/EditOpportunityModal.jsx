...
function EditOpportunityModal({ opportunity, onClose, onUpdate }) {
  ...
  // Pre-populate form fields from opportunity prop
  useEffect(() => {
    if (opportunity) {
      setFormData({
        ...
        psb_relationship: opportunity.psb_relationship || '',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        psb_relationship: formData.psb_relationship.trim() || null,
          ...
          <form onSubmit={handleSubmit}>
            <div className="px-6 py-4 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label htmlFor="psb_relationship" className="block text-sm font-medium text-gray-700 mb-1">
                    PSB Relationship
                  </label>
                  <input
                    type="text"
                    id="psb_relationship"
                    name="psb_relationship"
                    value={formData.psb_relationship}
                    onChange={handleChange}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
